...
> 截至 2026-07-05 · 14 层模块 · 43 个 Python 文件 · 82 测试全绿 · 11 个 CLI 命令 · 网页台(8页)· 中英双语 · pip 可安装
...
## 附:11 命令速查
`scan · validate · analyze · factors · portfolio · news · paper · cross · web · home · docs-pdf`
（详见 `docs/CLI.md`）
