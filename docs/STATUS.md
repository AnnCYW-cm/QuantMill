...
> 截至 2026-07-05 · 14 层模块 · 43 个 Python 文件 · 92 测试全绿 · 12 个 CLI 命令 · 网页台(8页)· 中英双语 · pip 可安装
...
## 附:12 命令速查
`scan · validate · analyze · factors · portfolio · news · paper · cross · experiment · web · home · docs-pdf`
（详见 `docs/CLI.md`）
